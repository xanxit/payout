const TopNav = () => {
  return (
    <div className="top-0 h-16 z-40 w-full bg-white border-b shadow-md">
      <div className="flex flex-wrap justify-between px-8 pt-4">
        ...
        <div>
        <img className="absolute hidden md:block top-6 md:pl-3" src="/images/search-icon.svg"/>
          <input
            id="topnav-search"
            placeholder="Search features, tutorials, etc."
            className="bg-[#F2F2F2] h-10 rounded-md pl-4 md:pl-8 pr-4 -mt-1" 
            style={{  }}
          />
